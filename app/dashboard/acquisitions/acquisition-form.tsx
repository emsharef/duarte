...
export function AcquisitionForm({ acquisition, initialObjects = [] }: AcquisitionFormProps) {
    ...
    const [acquiredFromId, setAcquiredFromId] = useState<string | undefined>(acquisition?.acquired_from_contact_id ?? undefined)
    const [boughtById, setBoughtById] = useState<string | undefined>(acquisition?.bought_by_contact_id ?? undefined)
